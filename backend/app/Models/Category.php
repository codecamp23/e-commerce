...
class Category extends Model
{
    ...
    protected $fillable = [
        'name', 'slug', 'brand_id', 'type', 'parent_category', 'ordering_number', 'banner', 'icon', 'image', 'image_name', 'image_size', 'image_extention', 'status', 'meta_title', 'meta_des', 'filtering_att'
    ];
